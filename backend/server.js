...
class Server {
    constructor() {
        ...
        this.app = express();
        this.AWS = new AWS(process.env.BUCKET_NAME, process.env.BUCKET_REGION, process.env.ACCESS_KEY_AWS_USER, process.env.SECRET_ACCESS_KEY_AWS_USER, process.env.DOMAIN_NAME, process.env.EMAIL_ADDRESS)
